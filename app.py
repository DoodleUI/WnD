...
import re
import binascii
from TextVisualRoutes import  TextSearchRoutes
from  DragAndDropRoutes import  DragAndDropRoute
...
app.register_blueprint(DragAndDropRoute)
app.register_blueprint(TextSearchRoutes)
